...
public partial class EventInfo : BaseUserControl
{
    ...
    protected void RegisterJavaScript()
    {
        ...
        cbPersonalHeader.InputAttributes["onclick"] = string.Format("{0}.CheckBoxes_OnClick(this, '{1}');",
                                                                    ClientJSObjectName, cblUsers.ClientID);

        cbGroupHeader.InputAttributes["onclick"] = string.Format("{0}.CheckBoxes_OnClick(this, '{1}');",
    ...
    private string InitializeEventInfoControllerScript
    {
        get
        {
            ...
            script.AppendFormat("var {0} = new EventInfoController('{0}', '{1}', '{2}');",
                                   ClientJSObjectName,
                                   cbPersonalHeader.ClientID, cbGroupHeader.ClientID);
    ...
    private void setPersonalEnable(bool value)
    {
        ...
        if (!value)
            cbPersonalHeader.InputAttributes.Add("disabled", "disabled");
        else
            cbPersonalHeader.InputAttributes.Remove("disabled");
    }
    ...
    private void setGroupEnable(bool value)
    {
        ...
        if (!value)
            cbGroupHeader.InputAttributes.Add("disabled", "disabled");
        else
            cbGroupHeader.InputAttributes.Remove("disabled");
    }
    ...
    public IList<int> OwnersUsersID
    {
        set
        {
            ...
            cbPersonalHeader.Checked = (value != null && value.Count != 0);
    ...
    public IList<Role> OwnersGroups
    {
        set
        {
            ...
            cbGroupHeader.Checked = (value != null && value.Count != 0);
