/**
 * $Id: Delegates.cs 77 2004-09-19 13:31:53Z meebey $
 * $URL: svn://svn.qnetp.net/smartirc/SmartIrc4net/tags/0.2.0/src/Delegates.cs $
 * $Rev: 77 $
 * $Author: meebey $
...
namespace Meebey.SmartIrc4net.Delegates
{
    ...
    public delegate void WhoEventHandler(string channel, string nick, string ident
                                        , string host, string realname
                                        , bool away, bool op, bool voice, bool ircop
                                        , string server, int hopcount, Data ircdata);
