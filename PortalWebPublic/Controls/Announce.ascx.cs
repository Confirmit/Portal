...
public partial class NewsTape_Announce : BaseUserControl
{
	...
	protected void Page_Load( object sender, EventArgs e )
	{
        ...
        if (Page.CurrentUser != null)
        {
            ...
            this.ds.SelectParameters["personID"].DefaultValue = Page.CurrentUser.ID.Value.ToString();
            this.gvNews.EmptyDataText = this.GetGlobalResourceObject("NewsTape", "EmptyActualNews").ToString();
        }
	}
    ...
    private void setOfficeImage(News news, Image image)
    {
        ...
        {
            image.ImageUrl = ConfigurationManager.AppSettings["generalNewsImage"];
    ...
    private void setAttachImage(News news, Image image)
    {
        ...
        image.ImageUrl = ConfigurationManager.AppSettings["attachmentsNewsImage"]; 
