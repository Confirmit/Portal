...
namespace AspNetForums.Controls {
    ...
    public class SearchPagerStyle : TableItemStyle {
        ...
        public String NextPageText {
            get {
                if (ViewState["spsNextPageText"] == null) return HttpContext.GetLocalResourceObject(Globals.SkinsDir + "Paging", "Next").ToString();
        ...
        public String PrevPageText {
            get {
                if (ViewState["spsPrevPageText"] == null) return HttpContext.GetLocalResourceObject(Globals.SkinsDir + "Paging", "Prev").ToString();
