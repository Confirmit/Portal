...
public partial class Admin_UserInfol : BaseUserControl
{
    ...
    private void fillUserInfo()
    {
        ...
        tbFirstName.MultilingualText = (MLText)user.FirstName;
        tbMiddleName.MultilingualText = (MLText)user.MiddleName;
        tbLastName.MultilingualText = (MLText)user.LastName;
    ...
    public virtual Person SaveUserChanges()
    {
        ...
        user.FirstName = (MLString)tbFirstName.MultilingualText;
        user.MiddleName = (MLString)tbMiddleName.MultilingualText;
        user.LastName = (MLString)tbLastName.MultilingualText;
