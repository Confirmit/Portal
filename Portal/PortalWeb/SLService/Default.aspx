<%@ Page Language="c#" MasterPageFile="~/MasterPages/Main.master" Inherits="Main_SLService"
    CodeFile="Default.aspx.cs" MaintainScrollPositionOnPostback="true" meta:resourcekey="Page"
    ...
    <table border="0" width="100%">
        <tr>
                    ...
                    <tr>
                        <td align="center">
                            ...
                            <% if (IsUsingSilverlightControl())
                               { %>
                            <asp:Silverlight ID="slDayInfo" runat="server" Source="~/ClientBin/DayInfo.xap" MinimumVersion="2.0.31005.0"
                                InitParameters="SLService=SLService/SLService.svc" Width="100%" Height="250">
            ...
            <td align="center" valign="top" width="40%">
                ...
                <asp:Silverlight ID="slEventsControl" runat="server" Source="~/ClientBin/Events.xap"
                    MinimumVersion="2.0.31005.0" InitParameters="MenuSource=xml/EventsMenu.xml,SLService=SLService/SLService.svc"
