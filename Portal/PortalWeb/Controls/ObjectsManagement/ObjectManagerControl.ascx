<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ObjectManagerControl.ascx.cs" Inherits="ObjectManagerControl" %>
...
<div align="left" class="control">
    <asp:UpdatePanel ID="upObjects" runat="server">
        <ContentTemplate>
            <asp:Panel ID="pnlObjectManagment" runat="server" Width="100%">
                <div class="control-header">
                    ...
                    <div class="control-header-buttons">
                        <asp:ImageButton ID="imgObjectManagmenCollapsedStatus" runat="server" ImageUrl="~/Images/expand.jpg" AlternateText="Show" />
                    </div>
                </div>
            </asp:Panel>
                    ...
                    <ContentTemplate>
                        ...
                        <div class="control-line-of-controls">
                            ...
                            <div style="float: left; width: 200px;">
                                <asp:DropDownList ID="ddlObjects" runat="server" AutoPostBack="True" CssClass="control-dropdownlist"
                                        Width="100%" onkeypress="return onKeypress(this, event)" />
                            </div>
                        </div>
                            ...
                            <ajaxToolkit:TabPanel ID="tpnPersonsInfo" runat="server" meta:resourcekey="PersonsInfo">
                                <ContentTemplate>
                                    <div class="control-line-of-controls" >
                                        ...
                                        <div style="float: left; width: 200px;">
                                            <asp:DropDownList ID="ddlUsers" runat="server" AutoPostBack="True" Width="100%"
                                                CssClass="control-dropdownlist" onkeypress="return onKeypress(this, event)" />
                                        </div>
                                    </div>
            ...
            <ajaxToolkit:CollapsiblePanelExtender ID="cpeObjectManagment" runat="server" TargetControlID="pnlObjectManagmentContent"
                ExpandControlID="pnlObjectManagment" CollapseControlID="pnlObjectManagment" Collapsed="true"
                ImageControlID="imgObjectManagmenCollapsedStatus" ExpandedImage="~/Images/collapse.jpg"
