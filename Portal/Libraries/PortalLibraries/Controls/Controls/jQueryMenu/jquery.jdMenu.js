...
(function($) {
    ...
    $.fn.jdMenuItem = function(strId) {
        var items = $('#' + strId, this);
        return items.length ? items : null; ;
    };

    $.fn.jdDisable = function() {
        ...
        if (navigator.appName == "Netscape") {
            ...
            if (this[0].getAttribute("onclick") != null)
                this.tmpAction = this[0].getAttribute("onclick");

            this.removeAttr("onclick");
        }
    };

    $.fn.jdEnable = function() {
        if (this == null || typeof (this) == 'undefined')
            return;
        ...
        if (navigator.appName == "Netscape") {
            ...
            if (typeof (this.tmpAction) != 'undefined')
                this[0].setAttribute("onclick", this.tmpAction);
        }
    };
    ...
    function getSettings(el) {
        var parent = $(el).parents('ul.jd_menu_flag_root')[0];
        return (parent != null)
			? $(el).parents('ul.jd_menu_flag_root')[0].$settings
			: null;
    }
