...
[assembly: WebResource("Controls.ExtenderBase.BaseScripts.js", "application/x-javascript")]
...
namespace Controls.ExtenderBase
{
    ...
    /// </summary>
    [ClientScriptResource(null, "Controls.ExtenderBase.BaseScripts.js")]
    public class ScriptControlBase : ScriptControl, INamingContainer, /*IControlResolver,*/ IPostBackDataHandler, ICallbackEventHandler//, IClientStateManager
    {
        ...
        /// <summary>
        /// Ensure of existing ScriptManager on the Page.
        /// </summary>
        private void ensureScriptManager()
        {
            if (_scriptManager == null)
            {
                ...
                if (_scriptManager == null)
                    throw new HttpException("Cannot find SciptManager on the Page.");
            }
        }
        ...
        protected virtual void DescribeComponent(ScriptComponentDescriptor descriptor)
        {
            try
            {
                ...
                ScriptObjectBuilder.DescribeComponent(this, descriptor, this);
            }
            finally
            {
