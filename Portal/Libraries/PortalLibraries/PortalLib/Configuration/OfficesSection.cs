...
{
	/// <summary>
	/// Configuration section for office provider.
	/// </summary>
	public class OfficesSection : ConfigurationElement
	{
		/// <summary>
		...
		/// </summary>
		[ConfigurationProperty( "providerType", DefaultValue = "ConfirmIt.PortalLib.DAL.SqlClient.SqlOfficesProvider" )]
