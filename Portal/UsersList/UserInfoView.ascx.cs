...
public partial class UserInfoView : BaseUserControl
{
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        if (CurrentUser == null || Page.CurrentUser.ID == null)
            return;

        UserStatisticsControl.UserID = Page.CurrentUser.ID;
        ...
        UserStatisticsControl.BeginDate = DateTime.Parse(beginDateString, dateTimeFormatInfo, DateTimeStyles.None);
        UserStatisticsControl.EndDate = DateTime.Parse(endDateString, dateTimeFormatInfo, DateTimeStyles.None);
