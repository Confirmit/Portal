...
namespace AspNetForums.Controls
{
    ...
    public class Paging : WebControl, INamingContainer
    {
        ...
        {
            currentPage.Text = HttpContext.GetLocalResourceObject(Globals.SkinsDir + "Paging", "Page").ToString() +
                (PageIndex + 1).ToString("n0") + HttpContext.GetLocalResourceObject(Globals.SkinsDir + "Paging", "Of").ToString() +
        ...
        private void DisplayNumericalPaging()
        {
            ...
            // But first check if there are any controls
            //if (numericalPaging == null) return;
        ...
        private Control NavigationDisplay(bool singlePage)
        {
            ...
            if (!singlePage)
            {
                ...
                navigationText.Text = HttpContext.GetLocalResourceObject(Globals.SkinsDir + "Paging", "GoToPage").ToString();
        ...
        private Control CreateNumericalNavigation()
        {
            ...
            for (int i = 0; i < linkButtonsToCreate; i++)
            {
                ...
                numericalLinkButtons[i].ID = "num" + (i + 1).ToString();
        ...
        private Control CreatePrevNextNavigation()
        {
            ...
            prev.Text = HttpContext.GetLocalResourceObject(Globals.SkinsDir + "Paging", "Prev").ToString();
            prev.ID = "Prev";
            ...
            next.Text = HttpContext.GetLocalResourceObject(Globals.SkinsDir + "Paging", "Next").ToString();
            next.ID = "Next";
        ...
        public int TotalRecords
        {
            ...
            set
            {
                TotalPages = CalculateTotalPages(value, PageSize,0);
        ...
        /// 
        // ********************************************************************/
        public static int CalculateTotalPages(int totalRecords, int pageSize, int pinned)
        {
            ...
            totalPagesAvailable = (totalRecords - pinned) / (pageSize - pinned);

            // Now do a mod for any remainder
            if ((totalRecords - pinned) % (pageSize - pinned) > 0)
                totalPagesAvailable++;
