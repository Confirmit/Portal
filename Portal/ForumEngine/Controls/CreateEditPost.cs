...
namespace AspNetForums.Controls
{
    ...
    public class CreateEditPost : WebControl, INamingContainer
    {
        ...
        CheckBox chkPinnedPost;
        User user;

        /*************** Property and Class contants ****************/
        // the default messages for posting a new message, replying to a message, and editing a message
        String _defaultPostNewMessageText;
        String _defaultEditMessageText;
        String _defaultReplyToMessageText;
        String _defaultPreviewMessageText;
        readonly String _defaultRedirectUrl = Globals.UrlHome;
        ...
        ***********************************************************************/
        protected override void CreateChildControls()
        {
            ...
            _defaultPostNewMessageText = HttpContext.GetLocalResourceObject(Globals.SkinsDir + "CreateEditPost", "_defaultPostNewMessageText").ToString();
            _defaultEditMessageText = HttpContext.GetLocalResourceObject(Globals.SkinsDir + "CreateEditPost", "_defaultEditMessageText").ToString();
            _defaultReplyToMessageText = HttpContext.GetLocalResourceObject(Globals.SkinsDir + "CreateEditPost", "_defaultReplyToMessageText").ToString();
            _defaultPreviewMessageText = HttpContext.GetLocalResourceObject(Globals.SkinsDir + "CreateEditPost", "_defaultPreviewMessageText").ToString();
            ...
            {
                HttpContext.Current.Response.Redirect(Globals.UrlMessage + Convert.ToInt32(Messages.ProblemPosting));
            ...
            try
            {
                postForm = Page.LoadControl(Globals.ApplicationVRoot + Globals.ForumsDirectory + "/Skins/" + Globals.Skin + "/Skins/Skin-Post.ascx");
            }
        ...
        private Post GetPostForEdit()
        {
            ...
            try
            {
                post = Posts.GetPost(PostID, Users.GetLoggedOnUser().Username);
            }
            ...
            if (((post.Username.ToLower() == Users.GetLoggedOnUser().Username.ToLower())) || (Users.GetLoggedOnUser().IsAdministrator))
            {
                return post;
            }
        ...
        ***********************************************************************/
        private void DisplayEdit(Control controlTemplate)
        {
            ...
            ((Label)controlTemplate.FindControl("PostEditor")).Text = user.DisplayName;
            ...
            // Allow pinned posts?
            if ((user.IsAdministrator) && (Mode != CreateEditPostMode.ReplyToPost) && post.ParentID == 0)
            {
                controlTemplate.FindControl("AllowPinnedPosts").Visible = true;

                pinnedPost = (DropDownList)controlTemplate.FindControl("PinnedPost");
                pinnedPost.Items.Add(new ListItem(HttpContext.GetLocalResourceObject(Globals.SkinsDir + "CreateEditPost", "pinnedPost10").ToString(), "-1"));
                pinnedPost.Items.Add(new ListItem(HttpContext.GetLocalResourceObject(Globals.SkinsDir + "CreateEditPost", "pinnedPost0").ToString(), "0"));
                pinnedPost.Items.Add(new ListItem(HttpContext.GetLocalResourceObject(Globals.SkinsDir + "CreateEditPost", "pinnedPost1").ToString(), "1"));
                pinnedPost.Items.Add(new ListItem(HttpContext.GetLocalResourceObject(Globals.SkinsDir + "CreateEditPost", "pinnedPost2").ToString(), "3"));
                pinnedPost.Items.Add(new ListItem(HttpContext.GetLocalResourceObject(Globals.SkinsDir + "CreateEditPost", "pinnedPost3").ToString(), "7"));
                pinnedPost.Items.Add(new ListItem(HttpContext.GetLocalResourceObject(Globals.SkinsDir + "CreateEditPost", "pinnedPost4").ToString(), "14"));
                pinnedPost.Items.Add(new ListItem(HttpContext.GetLocalResourceObject(Globals.SkinsDir + "CreateEditPost", "pinnedPost5").ToString(), "30"));
                pinnedPost.Items.Add(new ListItem(HttpContext.GetLocalResourceObject(Globals.SkinsDir + "CreateEditPost", "pinnedPost6").ToString(), "90"));
                pinnedPost.Items.Add(new ListItem(HttpContext.GetLocalResourceObject(Globals.SkinsDir + "CreateEditPost", "pinnedPost7").ToString(), "180"));
                pinnedPost.Items.Add(new ListItem(HttpContext.GetLocalResourceObject(Globals.SkinsDir + "CreateEditPost", "pinnedPost8").ToString(), "360"));
                pinnedPost.Items.Add(new ListItem(HttpContext.GetLocalResourceObject(Globals.SkinsDir + "CreateEditPost", "pinnedPost9").ToString(), "999"));
            ...
            allowNoReplies.Checked = post.IsLocked;

            chkPinnedPost = (CheckBox)controlTemplate.FindControl("chkPinnedPost");
            chkPinnedPost.Checked = post.PinnedPost;
            if (!user.IsAdministrator)
                chkPinnedPost.Visible = false;
        ...
        ***********************************************************************/
        private void DisplayPost(Control controlTemplate)
        {
            ...
            // Set the Username
            ((Label)controlTemplate.FindControl("PostAuthor")).Text = user.DisplayName;

            // Allow pinned posts?
            if ((user.IsAdministrator) && (Mode != CreateEditPostMode.ReplyToPost))
            {
                controlTemplate.FindControl("AllowPinnedPosts").Visible = true;
        ...
        ************************************************************************/
        private void PreviewButton_Click(Object sender, EventArgs e)
        {
            ...
            // Set the title text
            ((Label)form.FindControl("PostTitle")).Text = HttpContext.GetLocalResourceObject(Globals.SkinsDir + "CreateEditPost", "Preview").ToString();
        ...
        ***********************************************************************/
        private void DisplayReply(Control control)
        {
            ...
            // Set the Username
            label = (Label)control.FindControl("ReplyPostedBy");
            label.Text = Users.GetUserInfo(post.Username).DisplayName;

            // Set the date
            ((Label)control.FindControl("ReplyPostedByDate")).Text = " on " + post.PostDate.ToString(Globals.DateFormat + " " + Globals.TimeFormat);
    ...
    public class PostStyle : Style
    {
        ...
        // the default text for the Post button
        String _defaultPostText = HttpContext.GetLocalResourceObject(Globals.SkinsDir + "CreateEditPost", "_defaultPostText").ToString();
        // the default text for the Preview button
        String _defaultPreviewText = HttpContext.GetLocalResourceObject(Globals.SkinsDir + "CreateEditPost", "_defaultPreviewText").ToString();
        // the default text for the Post button in Edit mode
        String _defaultEditModePostText = HttpContext.GetLocalResourceObject(Globals.SkinsDir + "CreateEditPost", "_defaultEditModePostText").ToString();
        // the default text for the Preview button in Edit mode
        String _defaultEditModePreviewText = HttpContext.GetLocalResourceObject(Globals.SkinsDir + "CreateEditPost", "_defaultEditModePreviewText").ToString();
        /***************************************************/
    ...
    public class PreviewPostSyle : Style
    {
        ...
        String _defaultCancelText = HttpContext.GetLocalResourceObject(Globals.SkinsDir + "CreateEditPost", "_defaultCancelText").ToString();
        // the default text for the Post button
        String _defaultPostText = HttpContext.GetLocalResourceObject(Globals.SkinsDir + "CreateEditPost", "_defaultPostText").ToString();
        // the default text for the "Edit the Post" button
        String _defaultReturnToEditText = HttpContext.GetLocalResourceObject(Globals.SkinsDir + "CreateEditPost", "_defaultReturnToEditText").ToString();
        // the default text for the Post button when in Edit mode
        String _defaultEditModePostText = HttpContext.GetLocalResourceObject(Globals.SkinsDir + "CreateEditPost", "_defaultEditModePostText").ToString();
        // the default text for the "Edit the Post" button when in Edit mode
        String _defaultEditModeReturnToEditText = HttpContext.GetLocalResourceObject(Globals.SkinsDir + "CreateEditPost", "_defaultEditModeReturnToEditText").ToString();
        /***************************************************/
