...
namespace AspNetForums.Controls
{
    ...
    public class PostView : WebControl, INamingContainer
    {
        ...
        private void SetViewMode()
        {
            ...
            try
            {
                controlTemplate = Page.LoadControl(Globals.ApplicationVRoot + Globals.ForumsDirectory + "/Skins/" + Globals.Skin + "/Skins/" + TemplateName);
            }
        ...
        private void InitializeCommonTemplateItems()
        {
            ...
            if (newThreadLink != null)
            {
                ...
                // Find the new thread image
                newThreadImage = (System.Web.UI.WebControls.Image)controlTemplate.FindControl("NewThreadImageTop");
                if (newThreadImage != null)
                {
                    newThreadImage.ImageUrl = Globals.ApplicationVRoot + Globals.ForumsDirectory + "/Skins/" + skinName + "/images/newthread.gif";

                }
                else
                {
                    newThreadLink.Text = HttpContext.GetLocalResourceObject(Globals.SkinsDir + "PostView", "newThreadLink").ToString();
                }
            }
        }
