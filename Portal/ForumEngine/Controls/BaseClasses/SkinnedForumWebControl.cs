...
namespace AspNetForums.Controls {
    ...
    public abstract class SkinnedForumWebControl : UserControl, INamingContainer {
        ...
        protected Control LoadSkin() {
            ...
            SkinName = "default";
            string skinPath = Globals.ApplicationVRoot + "/" + Globals.ForumsDirectory + "/skins/default/Skins/" + SkinFilename;
            ...
            try {
                ...
                try {
                    skin = Page.LoadControl(Globals.ApplicationVRoot + "/" + Globals.ForumsDirectory + "/skins/default/Skins/" + SkinFilename);
                } 
                catch (FileNotFoundException) {
                    // Can't load a skin
