<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_AdminOperations" MasterPageFile="~/MasterPages/Main.master" meta:resourcekey="PageResource1" CodeBehind="AdminOperations.aspx.cs" %>
...
<asp:Content ID="cntntMain" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <table border="0px" cellspacing="0">
        ...
        <tr>
            <td align="left">
                <uc1:ImageLinkButton ID="AdminRulesListPage" runat="server"
                    ImageUrl="~/Images/admin/user_attr.png"
                    ImageWidth="40"
                    LinkCssClass="control-hyperlink-big"
                    Href="~/Admin/AdminRulesListPage.aspx"
                    meta:resourcekey="AdminRulesListPage"/>
            </td>
        </tr>
        <tr>
            <td align="left">
                <uc1:ImageLinkButton ID="AdminGroupsListPage" runat="server"
                    ImageUrl="~/Images/admin/user_attr.png"
                    ImageWidth="40"
                    LinkCssClass="control-hyperlink-big"
                    Href="~/Admin/AdminGroupsListPage.aspx"
                    meta:resourcekey="AdminGroupsListPage" />
            </td>
        </tr>
    </table>
</asp:Content>
