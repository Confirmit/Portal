...
public partial class Admin_AdminArrangementsPage : BaseWebPage
{
	#region Classes
	...
	protected void repOffices_OnItemDataBound(object sender, RepeaterItemEventArgs e)
	{
		if ((e.Item.ItemType == ListItemType.Item) || (e.Item.ItemType == ListItemType.AlternatingItem))
		{
			...
			HyperLink hl1 = arrList.FindControl("hlAddArr") as HyperLink;
			HyperLink hl2 = arrList.FindControl("hlAddCH") as HyperLink;
