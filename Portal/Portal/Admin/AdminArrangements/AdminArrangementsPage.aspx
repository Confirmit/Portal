<%@ Page Language="C#" MasterPageFile="~/MasterPages/Main.master" AutoEventWireup="true" Inherits="Admin_AdminArrangementsPage"
    MaintainScrollPositionOnPostback="true" Codebehind="AdminArrangementsPage.aspx.cs" %>

<%@ Register Src="~/Admin/AdminMenu.ascx" TagPrefix="uc1" TagName="AdminMenu" %>
<%@ Register Src="~/Admin/AdminArrangements/Controls/ArrangementsList.ascx" TagPrefix="uc2" TagName="ArrangementsList" %>
