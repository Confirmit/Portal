...
public partial class NewDay : BaseUserControl
{
    ...
    private void InformLastUser()
    {
        ...
        {
            var notifyLastUserExecutor = new NotifyLastUserExecutor(ruleRepository, new DBWorkEventTypeRecognizer(), new InstanceRuleRepository(), messageHelper, Person.Current.ID.Value);
