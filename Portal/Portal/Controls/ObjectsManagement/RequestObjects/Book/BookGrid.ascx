<%@ Control Language="C#" AutoEventWireup="true" Inherits="BookGrid" Codebehind="BookGrid.ascx.cs" %>
...
<div class="control">
    ...
    <cc1:GridView ID="gridViewReqObjects" runat="server" 
        ...
        <PagerSettings PageButtonCount="2" NextPageText="Next" PreviousPageText="Prev"/>
        ...
        <Columns>        
            ...
            <asp:BoundField SortExpression="PublishingYear" meta:resourcekey="PublishingYear" DataField="PublishingYear" >
                <ItemStyle Width="20%" />
                <HeaderStyle HorizontalAlign="Left" />
            </asp:BoundField>
