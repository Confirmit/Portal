<%@ Control Language="C#" AutoEventWireup="true" Inherits="Grid" Codebehind="Grid.ascx.cs" %>

<%@ Register Src="~/Controls/UpdateProgress.ascx" TagName="MyUpdateProgress" TagPrefix="uc" %>
<%@ Register Src="~/Controls/ShadowLine.ascx" TagName="ShadowLine" TagPrefix="uc" %>
				...
				<asp:PlaceHolder ID="phPager" runat="server">
					<tr>
						<td style="padding-top: 3px; padding-bottom: 5px;">
							<uc:ShadowLine ID="ucShadowLine1" runat="server" />
						</td>
					</tr>
					<tr>
						<td>
							<table align="center" id="tblControl" cellspacing="0" cellpadding="0" border="0">
								<tr>
									...
									<td>
										<uc:MyUpdateProgress ID="updateProgress" runat="server" meta:resourcekey="updateProgress" />
									</td>
								</tr>
							</table>
						</td>
					...
					<tr>
						<td style="padding-top: 5px; padding-bottom: 5px;">
							<uc:ShadowLine ID="ucShadowLine2" runat="server" />
						</td>
					</tr>
				</asp:PlaceHolder>
				<tr>
