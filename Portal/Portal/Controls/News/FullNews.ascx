<%@ Control Language="C#" AutoEventWireup="true" Inherits="NewsTape_FullNews" Codebehind="FullNews.ascx.cs" %>
    ...
    <tr runat="server" id="trLinks">
        <td>
            <div style="float: left;padding-left: 20%">
                <asp:LinkButton CssClass="control-hyperlink" 
                    ID="hlDiscussOnForum" runat="server" 
                    OnClick="hlDiscussOnForum_Click" />
            </div>                        
            <div style="float: left; padding-left: 6px;">
                <asp:LinkButton CssClass="control-hyperlink" 
                    ID="hlEditNews" PostBackUrl="~//NewsTape//AddNews.aspx?id=" 
                    runat="server" />
            </div>                        
            <div style="float: left; padding-left: 6px;">
                <asp:LinkButton CssClass="control-hyperlink" 
                    ID="hlSendToArchive" runat="server" 
                    OnClick="hlSendToArchive_Click" />
            </div>                        
            <div style="float: left; padding-left: 6px;">
                <asp:LinkButton CssClass="control-hyperlink" 
                    ID="hlDeleteNews" runat="server" 
                    OnClick="hlDeleteNews_Click" />
            </div>
        </td>
    </tr>
</table>
