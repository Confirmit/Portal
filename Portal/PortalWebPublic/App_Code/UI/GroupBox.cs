...
{
	/// <summary>
	/// “ип отображени€ контрола.
	/// </summary>
	public enum GroupBoxDisplayType
	{
		/// <summary>
		/// —осто€ние сохран€етс€ между запросами.
		/// </summary>
		Custom = 0,
		/// <summary>
		/// ¬сегда открыт.
	...
	/// <summary>
	///  онтрол дл€ группировки других контролов.
	/// </summary>
	public class GroupBox : PlaceHolder, ITextControl
	{
		...
		protected override void Render( HtmlTextWriter writer )
		{
			...
			// рендерим блок, который будет отображатьс€ в открытом состо€нии
			...
			// рендерим блок, который будет отображатьс€ в закрытом состо€нии
			writer.Write(String.Format(
			...
			else
			{
				...
				{
					string script;
					// если это перва€ загрузка то группбокс свернут 
					if (!Page.IsPostBack)
					{
