...
public partial class Arrangements_Controls_ArrangementsList : BaseUserControl
{
    ...
    public int OfficeID
    {
        ...
        set
        {
            ...
            //hlAddArr.NavigateUrl = "~/Arrangements/AddEditArrangement.aspx?officeid=" + value.ToString();
            //hlAddCH.NavigateUrl = "~/Arrangements/AddEditConferenceHall.aspx?officeid=" + value.ToString();
        }
    }
